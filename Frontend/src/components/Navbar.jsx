...
return ()=>{
  ...
  return (
    <>
      <div className={`max-w-screen-2xl container mx-auto md:px-20 py-4 dark:bg-slate-900 dark:text-white fixed top-0 left-0 right-0 z-50
        ${
  ...
  </div><div className='hidden md:block'><label className=" px-3 py-2 border rounded-md flex items-center gap-2">
